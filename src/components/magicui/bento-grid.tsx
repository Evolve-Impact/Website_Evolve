...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu dark:bg-background dark:[border:2px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className
    )}
    {...props}
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        ...
        <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 dark:text-neutral-300 leading-snug">
          {name}
        </h3>
        {/* <p className="text-sm sm:text-base md:text-lg text-neutral-400 leading-relaxed">
          {description}
        </p> */}
        <p className="text-sm sm:text-base md:text-lg text-zinc-600 leading-relaxed line-clamp-5 sm:line-clamp-6">
          {description}
        </p>
      </div>
